...
if __name__ == '__main__':
	A = [[random.randint(0, 1) for i in range(6)] for j in range(200)]
	...
	matriz.par_mult(A, B)
	finP = time.time()
	print('\n\nMatriz A y B se han multiplicado con exito en SECUENCIAL ha tardado ', finS - inicioS, ' y en PARALELO ',
		  finP - inicioP)
